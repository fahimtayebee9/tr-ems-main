    ...
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 d-flex align-items-center justify-content-end">
                ...
                @include('admin.weekly-reports.modals.mdl-download-report-multiple')
                @include('admin.includes.modals.md-bulk-import-dailysales')
                @include('admin.weekly-reports.modals.mdl-generate-all-weekly')

                @if(session()->has('pdf_report_id'))
