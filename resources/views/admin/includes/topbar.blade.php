...
<div class="header">
    ...
    <div class="page-title-box">
        <h3>{{ \App\Models\CompanyDetail::orderby('id', 'desc')->first()->company_name }}</h3>
    </div>
    <!-- /Header Title -->
                                ...
                                <div class="media">
                                    <span class="avatar">
                                        @if (Auth::user()->image == null)
                                            <img alt="" src="{{ asset('storage/uploads/users/default.webp') }}">
                                        @else
                                            <img alt="" src="{{ asset('storage/uploads/users/'. Auth::user()->image) }}">
                                        @endif
                                    </span>
