<div class="modal fade" id="md-edit-department-{{ Illuminate\Support\Str::slug($role->name) }}" tabindex="-1" role="dialog" aria-labelledby="departmentEditModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('departments.update', $role) }}" method="post">
                @csrf
