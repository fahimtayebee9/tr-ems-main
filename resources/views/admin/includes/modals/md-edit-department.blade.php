<div class="modal fade" id="md-edit-department-{{ Illuminate\Support\Str::slug($department->name) }}" tabindex="-1" role="dialog" aria-labelledby="departmentEditModalLabel" aria-hidden="true">
