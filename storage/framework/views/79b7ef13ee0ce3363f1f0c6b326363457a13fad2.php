            ...
            <div class="card-group m-b-30">
                <div class="card bg-inverse-success">
                    <div class="card-body">
                        ...
                        <h3 class="mb-3">
                            <?php echo e(\App\Models\Application::where('status_by_astmanager', 2)->where('status_by_hr', 2)->get()->count()); ?>

                        </h3>
                        <p class="mb-0">
                            Previous Month 
                            <span class="text-muted">
                                <?php echo e(\App\Models\Application::whereMonth('created_at', date('m') - 1)
                ...
                <div class="card bg-inverse-danger">
                    <div class="card-body">
                        ...
                        <h3 class="mb-3">
                            <?php echo e(\App\Models\Application::where('status_by_astmanager', 3)->where('status_by_hr', 3)->get()->count()); ?>
                ...
                <div class="card bg-inverse-warning">
                    <div class="card-body">
                        ...
                        <h3 class="mb-3">
                            <?php echo e(\App\Models\Application::where('status_by_astmanager', 1)->where('status_by_hr', 1)->get()->count()); ?>
                ...
                <div class="card bg-inverse-info">
                    <div class="card-body">
                        ...
                        <h3 class="mb-3">
                            <?php echo e(\App\Models\Application::where('application_type', 1)->get()->count()); ?>

                        </h3>
                        <p class="mb-0">
                            Previous Month 
                            <span class="text-muted">
                                <?php echo e(\App\Models\Application::whereMonth('created_at', date('m') - 1)->get()->count()); ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped custom-table mb-0" id="tbl-leave-applications">
                            ...
                            <tbody id="tbd-leave-applications">
                                <?php $__currentLoopData = $applicationsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo e(Carbon\Carbon::parse($leave->created_at)->format('d M, Y')); ?>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('admin.application.show', $leave->id)); ?>" class="btn btn-sm btn-warning"
                                                data-toggle="tooltip" data-title="View">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            <a href="<?php echo e(route('admin.application.exportPDF', $leave)); ?>"
                                                class="btn btn-sm btn-info" data-toggle="tooltip" data-title="Download PDF">
                                                <i class="fa fa-download"></i>
                                            </a>
                                            <a href="<?php echo e(route('admin.application.destroy', $leave->id)); ?>"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\00_PROJECTS\tr-ems\resources\views/admin/applications/index.blade.php ENDPATH**/ ?>