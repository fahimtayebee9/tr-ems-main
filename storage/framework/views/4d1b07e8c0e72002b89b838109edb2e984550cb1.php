        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <div class="card dash-widget">
                <div class="card-body">
                    ...
                    <div class="dash-widget-info">
                        <h3>
                            <?php echo e(count($userList) - count($absentEmployeeList)); ?>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4 d-flex">
            <div class="card flex-fill">
                <div class="card-body">
                    <h4 class="card-title">
                        Today Absent
                        <span class="badge bg-inverse-danger ms-2"><?php echo e(count($absentEmployeeList)); ?></span>
                    </h4>
                    
                    <?php $__currentLoopData = $absentEmployeeList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>   
                        <div class="leave-info-box">
                            <div class="media d-flex align-items-center">
                                <a href="profile.html" class="avatar"><img alt="" src="assets/img/user.jpg"></a>
                                <div class="media-body flex-grow-1">
                                    <div class="text-sm my-0"><?php echo e($item->first_name . " " . $item->last_name); ?></div>
                                </div>
                            </div>
                            <div class="row align-items-center mt-3">
                                <div class="col-6">
                                    <h6 class="mb-0"><?php echo e(date('d M, Y')); ?></h6>
                    ...
                    <?php if(count($absentEmployeeList) > 2): ?>
...
<?php echo $__env->make('admin.layouts.app-v2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\00_PROJECTS\tr-ems\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>