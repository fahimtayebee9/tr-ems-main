<div class="modal fade" id="md-upload-departments" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.departments.import.bulk')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\00_PROJECTS\tr-ems\resources\views/admin/includes/modals/md-bulk-import-departments.blade.php ENDPATH**/ ?>