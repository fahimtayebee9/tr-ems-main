            ...
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle nav-user me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <?php if(Auth::user()->image): ?>
                        <img src="<?php echo e(asset('storage/uploads/users/'.Auth::user()->image)); ?>" alt="user" class="rounded-circle">
                    <?php else: ?>
                        <img src="<?php echo e(asset('assets/images/users/avatar-1.jpg')); ?>" alt="user" class="rounded-circle">
                    <?php endif; ?>
                    <span class="pro-user-name ms-1">
                        <?php echo e(Auth::user()->first_name . ' ' . Auth::user()->last_name); ?> <i class="uil uil-angle-down"></i> 
                    </span>
                </a>
                <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                    ...
                    <a href="<?php echo e(route('employee.profile')); ?>" class="dropdown-item notify-item">
                    ...
                    <form class="dropdown-item notify-item" method="POST" action="<?php echo e(route('logout')); ?>">
                        <?php echo csrf_field(); ?>
        ...
        <div class="logo-box">
            <a href="index.html" class="logo logo-dark">
                <span class="logo-sm">
                    ...
                    <?php else: ?>
                        <img src="<?php echo e(asset('storage/assets/images/browser.png')); ?>" alt="company logo" class="img-fluid w-50">
                    <?php endif; ?>
                </span>
                <span class="logo-lg">
                    <?php if(!empty(\App\Models\CompanyDetail::orderby('id', 'desc')->first()->company_logo)): ?>
...
</div><?php /**PATH C:\xampp\htdocs\00_PROJECTS\tr-ems\resources\views/employee/includes/topbar.blade.php ENDPATH**/ ?>